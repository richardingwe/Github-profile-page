...
fetch('https://api.github.com/graphql', {
    ...
    headers: {
        ...
        Authorization: 'bearer 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'
    },
    body: JSON.stringify({
        query: `
                query MyQuery {
...
function repos(result) {
    ...
    result.repositories.edges.forEach(repo => {
        ...
        console.log(repo.node.description);
        console.log(repo.node.forkCount);
        console.log(repo.node.updatedAt);
        console.log(repo.node.stargazerCount);
        // console.log(repo.node.languages.edges[0].node.name);
        // console.log(repo.node.languages.edges[0].node.color);
